Использование цвета для заголовков веток в **DRAKON-схемах Паронджанова** — это мощный инструмент, который выходит далеко за рамки эстетики. Вот детальное обоснование ключевых выгод:
